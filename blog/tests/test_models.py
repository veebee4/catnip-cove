...
class CategoryModelTests(TestCase):
    ...
    def test_category_str_method(self):
        """Test that the string representation of a category returns the category name"""
...
class PostModelTests(TestCase):
    ...
    def setUp(self):
        ...
        self.post = Post.objects.create(title=self.post_title, body=self.post_body)
        self.post.categories.add(self.category)

    def test_post_str_method(self):
        """Test that the string representation of a post returns the post title"""
    ...
    def test_post_ordering(self):
        """Test that posts are ordered by the created_on field in descending order"""
...
class CommentModelTests(TestCase):
    ...
    def setUp(self):
        ...
        self.category = Category.objects.create(name='Test Category')
        self.post = Post.objects.create(title='Test Post', body='This is a test post body.')
        self.comment_author = 'John Doe'
        self.comment_body = 'This is a test comment.'
        self.comment = Comment.objects.create(author=self.comment_author, body=self.comment_body, post=self.post)

    def test_comment_str_method(self):
        """Test that the string representation of a comment is in the format 'author on post'"""
        self.assertEqual(str(self.comment), f"{self.comment_author} on '{self.post}'")
