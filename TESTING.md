...
| **DONATING** |   |   |  |  |
| 17 | Donator | Make a donation for a particular cat | Make a donation that will be spent on a particular cat | Unfortunately, I did not get time to complete this so unable to complete this - There is an added comment box on the donation form so a user could specify a particular cat if they wanted | [Donation Form]() |
...
| **BLOG** |   |   |  |  |
| 22 | Registered User | View blog articles & comments | Gain information about cats |  |  |
...
| 28 | Superuser/Admin | Add a cat | Add new cats to the site |  |  |
| 29 | Superuser/Admin | Edit a cat | Keep records up-to-date |  |  |
| 30 | Superuser/Admin | Delete a cat | Keep records up-to-date and remove cats that are no longer in the rescue centre |  |  |
| 31 | Superuser/Admin | Receive a warning when I click the delete button | Avoid accidental deletion of a cat record/blog/comment |  |  |
